...
- **Quantum Dependency Graph (QDG) construction**
...
> ⚠️ **Note**  
> QStatic and srcML support for OpenQASM is still evolving. Some XML files are
> manually annotated with position (`pos`) attributes to enable precise slicing.
...
serving as a foundation for quantum change impact analysis (CIA) tools
